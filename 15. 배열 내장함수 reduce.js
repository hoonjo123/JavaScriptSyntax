...
let numbers1 = [4, 2, 5, 3, 6, 7, 8, 12, 15];
let numberSum = numbers1.reduce((acc, cur) => acc + cur, 0);
console.log(numberSum)

let numbberReturnTest = numbers1.reduce((acc, cur) => {
    return acc + cur;
}, 0);
console.log(numbberReturnTest);
